...
export namespace TarHeaderFieldDefinition {
	...
	// USTAR Fields
	export function ustarIndicator(): TarHeaderField { return ({ name: 'ustarIndicator', offset: 257, size: 6, type: TarHeaderFieldType.ASCII, constant: 'ustar\0' }) }
	export function ustarVersion(): TarHeaderField { return ({ name: 'ustarVersion', offset: 263, size: 2, type: TarHeaderFieldType.ASCII, constant: '00' }) }
	...
	export function padding(): TarHeaderField { return ({ name: 'padding', offset: 500, size: 12, type: TarHeaderFieldType.ASCII, constant: '000000000000' }) }
